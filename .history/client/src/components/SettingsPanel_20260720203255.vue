      ...
      <div class="tab-content">
        ...
        <div v-if="activeTab === 'basic'" class="setting-section">
          ...
          <div class="setting-item">
            <label>显示时钟</label>
            <label class="switch">
              <input type="checkbox" v-model="settingsStore.settings.showClock" @change="updateSetting('showClock', ($event.target as HTMLInputElement).checked)">
        ...
        <div v-if="activeTab === 'search'" class="setting-section">
          ...
          <div class="setting-item">
            <label>启用搜索栏</label>
            <label class="switch">
              <input type="checkbox" v-model="settingsStore.settings.enableSearch" @change="updateSetting('enableSearch', ($event.target as HTMLInputElement).checked)">
              <span class="slider"></span>
            </label>
          </div>
          <div class="setting-item">
            <label>搜索建议</label>
            <label class="switch">
              <input type="checkbox" v-model="settingsStore.settings.enableSearchSuggestion" @change="updateSetting('enableSearchSuggestion', ($event.target as HTMLInputElement).checked)">
              <span class="slider"></span>
            </label>
          </div>
          <div class="setting-item">
            <label>搜索历史</label>
            <label class="switch">
              <input type="checkbox" v-model="settingsStore.settings.enableSearchHistory" @change="updateSetting('enableSearchHistory', ($event.target as HTMLInputElement).checked)">
              <span class="slider"></span>
            </label>
          </div>
        </div>
